...
export default function PendingPropertiesPage() {
  ...
  return (
    <div className="page-enter">
      ...
      {isLoading ? <LoadingSkeleton count={4} type="row" /> : properties.length === 0 ? (
        <div className="text-center py-16 text-slate-500">No pending properties to review</div>
      ) : (
              ...
              <div key={prop._id} className="bg-white rounded-xl border border-slate-200 overflow-hidden">
                <div className="flex flex-col sm:flex-row">
                  ...
                  <div className="flex-1 p-4">
                    ...
                    {owner && (
                      <p className="text-xs text-slate-400">by {owner.name} · {formatDate(prop.createdAt)}</p>
                    )}
